...
#dataset1
dataset1 <- mega_all_cen_std_5 %>%dplyr::filter(study == "1") 
lm_df1_int_SD<-lm(DepB ~ isdNA + autocorNA + imeanNA + isdNA:imeanNA + autocorNA:imeanNA + Age + Sex, data=dataset1)
st_lm_df1_int_SD<-summ(lm_df1_int_SD,digits = getOption("jtools-digits", 3), confint = TRUE,scale = TRUE, transform.response = TRUE)
df1_int_SD<-st_lm_df1_int_SD$coeftable[7,1]

#dataset2
dataset2 <- mega_all_cen_std_5 %>%dplyr::filter(study == "2") 
lm_df2_int_SD<-lm(DepB ~ isdNA + autocorNA + imeanNA + isdNA:imeanNA + autocorNA:imeanNA + Age + Sex, data=dataset2)
st_lm_df2_int_SD<-summ(lm_df2_int_SD,digits = getOption("jtools-digits", 3), confint = TRUE,scale = TRUE, transform.response = TRUE)
df2_int_SD<-st_lm_df2_int_SD$coeftable[7,1]

#dataset3
dataset3 <- mega_all_cen_std_5 %>%dplyr::filter(study == "3") 
lm_df3_int_SD<-lm(DepB ~ isdNA + autocorNA + imeanNA + isdNA:imeanNA + autocorNA:imeanNA + Age + Sex, data=dataset3)
st_lm_df3_int_SD<-summ(lm_df3_int_SD,digits = getOption("jtools-digits", 3), confint = TRUE,scale = TRUE, transform.response = TRUE)
df3_int_SD<-st_lm_df3_int_SD$coeftable[7,1]

#dataset4
dataset4 <- mega_all_cen_std_5 %>%dplyr::filter(study == "4") 
lm_df4_int_SD<-lm(DepB ~ isdNA + autocorNA + imeanNA + isdNA:imeanNA + autocorNA:imeanNA + Age + Sex, data=dataset4)
st_lm_df4_int_SD<-summ(lm_df4_int_SD,digits = getOption("jtools-digits", 3), confint = TRUE,scale = TRUE, transform.response = TRUE)
df4_int_SD<-st_lm_df4_int_SD$coeftable[7,1]

#dataset5
dataset5 <- mega_all_cen_std_5 %>%dplyr::filter(study == "5") 
lm_df5_int_SD<-lm(DepB ~ isdNA + autocorNA + imeanNA + isdNA:imeanNA + autocorNA:imeanNA + Age + Sex, data=dataset5)
st_lm_df5_int_SD<-summ(lm_df5_int_SD,digits = getOption("jtools-digits", 3), confint = TRUE,scale = TRUE, transform.response = TRUE)
df5_int_SD<-st_lm_df5_int_SD$coeftable[7,1]

## Meta-analysis with metafor package
#bind moderation effects
SD_NA_5<-c(df1_int_SD,df2_int_SD,df3_int_SD,df4_int_SD,df5_int_SD)
