---
title: SENSITIVITY ANALYSES I (50% compliance exclusion)- Beyond main effects? Affect level as a moderator in the relation between affect dynamics and depressive symptoms
...
# EXPLANATION
This is the sensitivity analysis for the main findings of the paper, when a 50% compliance exclusion criterion was applied (i.e., participants were only included for analyses if they had at least 50% valid data)   
...
###### Removing participants with compliance below 50% ####  ####

## 50% of beeps ##
valbeep_RADAR <- (tot_ass_RADAR/100)*50
valbeep_RADAR 

## excluding those with fewer than 50% ##
...
## 50% of beeps ##
valbeep_LASER <- (tot_ass_LASER/100)*50
valbeep_LASER
...
## 50% of beeps ##
valbeep_YES <- (tot_ass_YES/100)*50
valbeep_YES
