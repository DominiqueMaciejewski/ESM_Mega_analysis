---
title: SENSITIVITY ANALYSES II (missing assessments not removed)- Beyond main effects? Affect level as a moderator in the relation between affect dynamics and depressive symptoms
...
This is the sensitivity analysis for the main findings of the paper, where no missing assessments were removed for the calculation of affect dynamics.
...
summ(lm_Base_PA_SDAR_main1,digits = getOption("jtools-digits", 3))
...
summ(lm_FU_PA_SDAR_main1,digits = getOption("jtools-digits", 3))
...
summ(lm_Base_NA_SDAR_main1,digits = getOption("jtools-digits", 3))
...
summ(lm_FU_NA_SDAR_main1,digits = getOption("jtools-digits", 3))
